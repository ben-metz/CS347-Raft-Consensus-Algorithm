...
void OnDataRecv(uint8_t * mac, uint8_t *incomingData, uint8_t len) {
  if (len == 1){
    ...
    Serial.println("Recieved from CLIENT 1");
  }
}
...
void loop()
{
  char* hello = "hello";
  delay(3000);
  esp_now_send(broadcastAddressSER, (uint8_t *) hello, sizeof(char) * 3);
  esp_now_send(broadcastAddressCL1, (uint8_t *) hello, sizeof(char) * 3);
}
